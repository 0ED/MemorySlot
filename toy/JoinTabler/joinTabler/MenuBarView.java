...
public class MenuBarView extends JMenuBar 
{
	 ...
	 */
	public MenuBarView() {
		this.makeMenuAndItem();
		this.setBackColor();
		this.setShortKeyToItem();
		this.insertItemToMenuBar();
	}
	...
	private void makeMenuAndItem() {
		menu = new JMenu[1];
		item = new JMenuItem[1][1]; //メニューが増えたときのため配列にしている

		menu[0] = new JMenu("メニュー");
		item[0][0] = new JMenuItem("環境設定");
	}
